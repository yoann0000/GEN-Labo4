...
public class OrdersWriterTest {
    ...
    public void OneOrderWithOneProduct() {
        order111.AddProduct(new Order.Product("Shirt", Order.Product.Color.blue, 3, 2.99, "TWD"));
    ...
    public void OneOrderWithOneProductNoSize() {
        order111.AddProduct(new Order.Product("Pot", Order.Product.Color.red, -1, 16.50, "SGD"));
